		...
		<label>Prénom</label> 
		<input class="inscription" name="prenom" type="text" value="Jacques">
		<label>Nom</label>
		<input class="inscription" name="nom" class="case" type="text" value="Célaire">
		<label>Age</label> 
		<input class="inscription" name="age" type="number" value="10">
		<label>Poids</label>
		<input class="inscription" name="poids" type="number" value="45">
		<label>Taille</label> 
		<input class="inscription" name="taille" type="number" value="139"> 
		<label>Sexe</label> 
		<?php
		if ($s == "Homme"){
