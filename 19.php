		...
		<label>Nom</label>
		<input class="inscription" name="nom" class="case" type="text" value="Guillaume">
		<label>Prénom</label> 
		<input class="inscription" name="prenom" type="text" value="PAULHE">
		<label>Age</label> 
		<input class="inscription" name="age" type="number" value="19">
		<label>Poids</label>
		<input class="inscription" name="poids" type="number" value="85">
		<label>Taille</label> 
