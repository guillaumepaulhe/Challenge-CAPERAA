		...
		<ul>
		<li class="case"> <form method="post"> <input name="nom" class="case" type="text" value="Albrecht"> <input name="prenom" type="text" value="Sebastien"> <input name="age" type="number" value="19"> <input name="poids" type="number" value="81"> <input name="taille" type="number" value="180"> <input name="sexe" type="text" value="Homme"> <br><input type="submit" value="Valider"> </form> </li>
		</ul>
		<?php
		...
		echo $edit_poids,"<br>";
		echo $edit_taille,"<br>";
		$edit_req_ma_table = $db->prepare("UPDATE participants SET Poids = 81 WHERE idParticipant = 11");
